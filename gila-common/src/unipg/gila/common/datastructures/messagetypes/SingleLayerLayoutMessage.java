...
/**
 * This class is used to carry the coordinates of the generating vertex across
 * the graph as an array of floats.
 * 
 * @author Alessio Arleo
 *
 */
public class SingleLayerLayoutMessage extends
        LayoutMessageMatrix<PartitionedLongWritable> {
