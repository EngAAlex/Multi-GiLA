 ...
 *
 */
public class SingleLayerLayoutMessage extends LayoutMessageMatrix<PartitionedLongWritable> {
...
//	private int deg;
	 ...
	 * 
	 */
	public SingleLayerLayoutMessage() {
		super();
	}
	 ...
	 * @param coords
	 */
	public SingleLayerLayoutMessage(PartitionedLongWritable payloadVertex, float[] coords){
	 ...
	 * @param coords
	 */
	public SingleLayerLayoutMessage(PartitionedLongWritable payloadVertex, int ttl, float[] coords){
...
//	}
	...
	public MessageWritable<PartitionedLongWritable, float[]> propagate() {
		SingleLayerLayoutMessage toReturn = new SingleLayerLayoutMessage(payloadVertex, ttl-1, new float[]{value[0], value[1]});
...
//			toReturn.setDeg(getDeg());
	...
	public MessageWritable<PartitionedLongWritable, float[]> propagateAndDie() {
		SingleLayerLayoutMessage toReturn = new SingleLayerLayoutMessage(payloadVertex, new float[]{value[0], value[1]});
		toReturn.setWeight(weight);
		return toReturn;
	}
...
//		}
	...
	public Writable newInstance() {
		return new SingleLayerLayoutMessage();
	}
	 ...
	 */
	@Override
	public LayoutMessageMatrix<PartitionedLongWritable> copy() {
		return new SingleLayerLayoutMessage(payloadVertex, ttl, value);
	}
