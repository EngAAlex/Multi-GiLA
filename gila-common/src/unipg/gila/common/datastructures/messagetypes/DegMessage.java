...
/**
 * This kind of message is used to prune the one degree messages and carries the
 * degree of the generating vertex.
 * 
...
public class DegMessage extends MessageWritable<Long, Integer> {
  ...
  /**
   * Constructor setting only payload vertex id and the value of the message,
   * leaving ttl to 0.
   * 
   * @param payloadVertex
   * @param deg
