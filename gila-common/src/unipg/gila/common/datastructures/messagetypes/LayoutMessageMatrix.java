...
public class LayoutMessageMatrix<I extends PartitionedLongWritable> extends
   ...
   * 
   * @see
   * unipg.gila.common.datastructures.messagetypes.MessageWritable#propagateAndDie
   * ()
   */
  @Override
   ...
   * 
   * @see
   * unipg.gila.common.datastructures.messagetypes.MessageWritable#specificRead
   * (java.io.DataInput)
   */
  @Override
   ...
   * 
   * @see
   * unipg.gila.common.datastructures.messagetypes.MessageWritable#specificWrite
   * (java.io.DataOutput)
   */
  @Override
