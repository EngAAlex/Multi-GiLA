...
public class SingleScaleLayout {
  ...
  public static class SingleSeeder extends
    AbstractSeeder<CoordinateWritable, IntWritable> {

    /*
     * (non-Javadoc)
     * 
     * @see unipg.gila.layout.AbstractSeeder#initialize(org.apache.giraph.graph.
     * GraphState, org.apache.giraph.comm.WorkerClientRequestProcessor,
     ...
     * 
     * @see
     * unipg.gila.layout.AbstractSeeder#compute(org.apache.giraph.graph.Vertex,
     * java.lang.Iterable)
     */
    @Override
    public
   ...
   * 
   * 1) If the message is received from a vertex not analyzed yet then the
   * acting force on it is computed. If the vertex who sent the message is a
   * neighbor then the attractive forces are computed; otherwise only the
   * repulsive ones.
   * 
   * 2) If the message TTL is > 0 it is decreased and the message is broadcasted
   * to the vertex neighbors.
   * 
   * 3) If the messages queues are activated, a portion of the messages is
   * popped from the queue and broadcasted.
   * 
   * @author Alessio Arleo
   *
   */
  public static class SinglePropagator extends
    AbstractPropagator<CoordinateWritable, IntWritable> {

    /*
     * (non-Javadoc)
     * 
     * @see
     * unipg.gila.layout.AbstractPropagator#initialize(org.apache.giraph.graph
     * .GraphState, org.apache.giraph.comm.WorkerClientRequestProcessor,
     * org.apache.giraph.graph.GraphTaskManager,
     * org.apache.giraph.worker.WorkerGlobalCommUsage,
     * org.apache.giraph.worker.WorkerContext)
     ...
     * 
     * @see
     * unipg.gila.layout.AbstractPropagator#compute(org.apache.giraph.graph.
   ...
   *
   */
  public static class SingleLayoutCCs extends
    LayoutCCs<CoordinateWritable, IntWritable> {
     ...
     * 
     * @see
     * unipg.gila.layout.LayoutRoutine.DrawingBoundariesExplorer#compute(org
     * .apache.giraph.graph.Vertex, java.lang.Iterable)
     */
    @Override
    public
      void
   ...
   *
   */
  public static class SingleDrawingScaler extends
    DrawingScaler<CoordinateWritable, IntWritable> {
    /*
     * (non-Javadoc)
     * 
     * @see
     * unipg.gila.layout.LayoutRoutine.DrawingBoundariesExplorerWithComponentsNo
     * #initialize(org.apache.giraph.graph.GraphState,
   ...
   *
   */
  public static class SingleDrawingExplorerWithComponentsNo extends
   ...
   *
   */
  public static class SingleDrawingExplorer extends
    DrawingBoundariesExplorer<CoordinateWritable, IntWritable> {

    /*
     * (non-Javadoc)
     * 
     * @see
     * unipg.gila.layout.LayoutRoutine.DrawingBoundariesExplorer#initialize(
  ...
  public static class SingleDummy
    extends
    AbstractComputation<LayeredPartitionedLongWritable, CoordinateWritable, IntWritable, LayoutMessage, LayoutMessage> {
